...
const BraavosAccountClassHash1 =
  '0x2c2b8f559e1221468140ad7b2352b1acvv5be32660d0bf1a3ae3a054a4ec5254e4'; // 03/jun/2023
const BraavosAccountClassHash =
  '0x0105c0cf7aadb6605c9538199797920884694b5ce84fc68f92c832b0c9f57ad9'; // 27/aug/2023, will probably change over time
...
export function calculateAddressBraavos(
  ...
  const BraavosProxyConstructorCallData =
    BraavosProxyConstructor(BraavosInitializer);
